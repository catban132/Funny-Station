...
{
    [DataField]
    public Dictionary<ThirstThreshold, FixedPoint2> ThirstScores = new()
    {
    ...
    [DataField]
    public Dictionary<HungerThreshold, FixedPoint2> HungerScores = new()
    {
    ...
    [DataField]
    public Dictionary<float, FixedPoint2> ChargeScores = new()
    {
        { 0.80f, 1.0f },
        { 0.35f, 2.0f },
        { 0.10f, 5.0f },
